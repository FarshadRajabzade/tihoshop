...
<div class="col-6 col-md-4 col-lg-3">
    <?php endif; ?>
    <div <?php wc_product_class('ts-product border-none shadow-product ts-card product-style-3 item', $product); ?>>
        <?php
        /**
        ...
        <div class="product-loop-footer">
             ...
             * @hooked woocommerce_template_loop_add_to_cart_style_2 - 10
             */
            do_action('tihoshop_woocommerce_add_to_cart_style_2');
            ?>
        </div>
